...
{
public:
    static void drawFadeHandle(juce::Graphics& g, const FadeHandle& handle, int componentWidth, uint16_t boxWidth,
                               int componentHeight);

    static void drawFadePath(juce::Graphics& g, const FadeHandle& handle);

    static void drawAllFades(juce::Graphics& g, const FadeHandle& fadeIn, const FadeHandle& fadeOut, int componentWidth,
...
private:
    ...
    static void drawSingleHandle(juce::Graphics& g, const FadeHandle& handle, int componentWidth, uint16_t boxWidth,
                                 int componentHeight);
};
